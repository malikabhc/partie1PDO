...
<head>
  ...
  <title>Colyseum - Liste des clients</title>
</head>
<body>
      <h1 class="text-center">1 - Liste de tous les clients</h1>
        ...
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody>
            <?php foreach($clientList as $clientDetail){ ?>
              <tr>
                <td class="text-center"><?= $clientDetail->lastName ?></td>
                <td class="text-center"><?= $clientDetail->firstName ?></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
